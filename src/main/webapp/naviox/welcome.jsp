...
In sistemainventario-labels_en.properties:
sistemainventario=My application
sistemainventario[description]=My application does this and that

In sistemainventario-messages_en.properties:
